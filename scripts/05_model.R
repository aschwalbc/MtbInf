...
isos <- unique(ARI$iso3) # 204 countries
list_df <- list()
...
for (c in 1:(length(isos))){
  ...
  state <- c(S0004 = exp((-(ari[year == 1950 & ageARI == "00-14", ari][1])*2.5)), 
             ...
             I0004b = (1-exp((-(ari[year == 1950 & ageARI == "00-14", ari][1])*2.5)))*(1/(sum(1+1+2+(maxage[1]-3)))), 
             I0004c = (1-exp((-(ari[year == 1950 & ageARI == "00-14", ari][1])*2.5)))*(2/(sum(1+1+2+(maxage[1]-3)))), 
             I0004d = (1-exp((-(ari[year == 1950 & ageARI == "00-14", ari][1])*2.5)))*((maxage[1]-3)/(sum(1+1+2+(maxage[1]-3)))), 
             S0509 = exp((-(ari[year == 1950 & ageARI == "00-14", ari][1])*7.5)), 
             I0509a = (1-exp((-(ari[year == 1950 & ageARI == "00-14", ari][1])*7.5)))*(1/(sum(1+1+2+(maxage[2]-3)))), 
             I0509b = (1-exp((-(ari[year == 1950 & ageARI == "00-14", ari][1])*7.5)))*(1/(sum(1+1+2+(maxage[2]-3)))), 
             I0509c = (1-exp((-(ari[year == 1950 & ageARI == "00-14", ari][1])*7.5)))*(2/(sum(1+1+2+(maxage[2]-3)))), 
             I0509d = (1-exp((-(ari[year == 1950 & ageARI == "00-14", ari][1])*7.5)))*((maxage[2]-3)/(sum(1+1+2+(maxage[2]-3)))),
             S1014 = exp((-(ari[year == 1950 & ageARI == "00-14", ari][1])*12.5)), 
             I1014a = (1-exp((-(ari[year == 1950 & ageARI == "00-14", ari][1])*12.5)))*(1/(sum(1+1+2+(maxage[3]-3)))), 
             I1014b = (1-exp((-(ari[year == 1950 & ageARI == "00-14", ari][1])*12.5)))*(1/(sum(1+1+2+(maxage[3]-3)))), 
             I1014c = (1-exp((-(ari[year == 1950 & ageARI == "00-14", ari][1])*12.5)))*(2/(sum(1+1+2+(maxage[3]-3)))),
             I1014d = (1-exp((-(ari[year == 1950 & ageARI == "00-14", ari][1])*12.5)))*((maxage[3]-3)/(sum(1+1+2+(maxage[3]-3)))), 
